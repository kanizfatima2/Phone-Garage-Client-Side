    ...
    return (
        ...
        <div className="hero my-16">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                    <h1 className="text-2xl font-bold">About Phone Garage</h1>
                    <p className="py-6">We are Passionate About our Customers , Our Products and the Industry!</p>
                    <section className="p-6 my-2 text-gray-100">
                    ...
                    <button className="btn btn-warning bg-gradient-to-r from-orange-600 to-yellow">Learn More</button>
                </div>
            </div>
        </div>
