                ...
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <Link rel="noopener noreferrer" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center w-16 h-12 rounded-full bg-violet-400">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfrXNbQ9k1MyH5em-MyIrQQvAaEcmh2_qW3A&usqp=CAU" alt="" />
                            </div>
                            <span className="self-center text-2xl font-semibold">Phone Garage</span>
                        </Link>
                    </div>
